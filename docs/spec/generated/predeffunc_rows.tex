 ...
 \hline
          144 & \hyperref[sec:serialization:operation:StripErgoTreeHeader]{\lst{StripErgoTreeHeader}} & \parbox{4cm}{\lst{stripErgoTreeHeader:} \\ \lst{(Coll[Byte])} \\ \lst{  => Coll[Byte]}} & Removes the header byte from a serialized ErgoTree \\
 \hline
