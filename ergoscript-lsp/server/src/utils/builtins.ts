...
export const ERGOSCRIPT_KEYWORDS = [
...
export const ERGOSCRIPT_BUILTINS: BuiltinFunction[] = [
    {
        name: 'blake2b256',
...
export const ERGOSCRIPT_TYPES: TypeDefinition[] = [
    {
        name: 'Int',
